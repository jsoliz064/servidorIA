...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="px-4 py-2 my-2 text-center border-bottom">
        <h1 class="display-5 fw-bold">Perro o gato</h1>
      </div>
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-md-4 offset-md-4 text-center">
            ...
            <canvas id="otrocanvas" width="150" height="150" style="background: blue;"></canvas>
  ...
  <script type="text/javascript">
    ...
    (async() => {
      ...
      modelo = await tf.loadLayersModel("{{asset('model.json')}}");
    ...
    function predecir() {
      if (modelo != null) {
        ...
        img.src = '/img/3.jpg';
        var cnv= new Canvas(100,100);
        cnv.drawImage(img);
        var imgData=cnv.getImageData(0,0, 100, 100);
